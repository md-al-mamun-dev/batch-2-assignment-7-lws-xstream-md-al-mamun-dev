    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-r bg-color-bg via-gray-300 bg-color-bg text-white opacity-40">
        <div className="text-center">
          ...
          <h2 className="text-4xl font-semibold mb-8">{`Oops! Video not found`}</h2>
          <p className="text-lg mb-8">{`Sorry, the Video you are looking for doesn't exist or has been moved.`}</p>
